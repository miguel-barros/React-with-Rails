    ...
    return (
        <div className='w-full h-full mt-5 flex items-center justify-center flex-col'>
            <div className='w-7/12 flex items-center justify-between mb-5'>
                <input type="text" className='border border-gray-200 rounded-xl py-1 px-4 w-6/12 mr-3 outline-none' placeholder='New todo name' onChange={(e) => setNewTodo({ ...newTodo, name: e.target.value })} value={newTodo.name} />
                <input type="text" className='border border-gray-200 rounded-xl py-1 px-4 w-full mr-3 outline-none' placeholder='New todo description' onChange={(e) => setNewTodo({ ...newTodo, description: e.target.value })} value={newTodo.description} />
